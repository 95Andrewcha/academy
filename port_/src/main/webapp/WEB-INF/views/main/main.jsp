    ...
    <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="${contextPath }/resources/common/img/carousel-1.jpg" alt="Image">
            ...
            <div class="carousel-item">
                <img class="w-100" src="${contextPath }/resources/common/img/carousel-2.jpg" alt="Image">
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-lg-7">
        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="about-img position-relative overflow-hidden p-5 pe-0">
                    <img class="${contextPath }/resources/common/img-fluid w-100" src="img/about.jpg">
                </div>
            </div>
