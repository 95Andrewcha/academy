				...
				<form id="enroll" method='POST'>
					...
					<fieldset class="row mb-3">
						...
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input dis" type="radio"
									name="gridRadios" id="check_pay" value="option1" checked>
								<label class="form-check-label" for="gridRadios1"> 비율 할인
								</label>
							</div>
							<div class="form-check">
								<input class="form-check-input dis" type="radio"
									name="gridRadios" id="check_per" value="option2"> <label
									class="form-check-label" for="gridRadios2"> 금액 할인 </label>
							</div>
						</div>
					</fieldset>
					<div class="row mb-3 align-items-center">
						<label for="inputEmail3" class="col-sm-2 col-form-label">할인
							금액 입력</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="pay" name="discount">
						</div>
						<div class="col-sm-3 p-0">
							<div class="d-flex align-items-center">원</div>
					...
					<div class="row mb-3 align-items-center">
						<label for="inputEmail3" class="col-sm-2 col-form-label">할인
							비율</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="percent" name="discount2" disabled>
						</div>
						<div class="col-sm-3 p-0">
					...
					<button class="btn btn-primary" onclick="insert()">등록하기</button>
